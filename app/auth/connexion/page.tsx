...
export default function LoginPage() {
  ...
  const getRedirectPath = (user: any) => {
    ...
    const organismeCode = organization?.code?.toLowerCase();

    if (role === 'SUPER_ADMIN') {
      return '/super-admin/dashboard';
    }

    if (['ADMIN', 'MANAGER', 'AGENT'].includes(role) && organismeCode) {
      return `/${organismeCode}/dashboard`;
    }
            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Portail d'accès aux organismes</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl w-full">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Choisissez votre mode d'accès selon votre profil
            </p>
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="shadow-xl border-2 border-green-200">
                <CardHeader className="text-center bg-gradient-to-r from-blue-50 to-green-50">
                  ...
                  <CardTitle className="text-2xl font-bold text-gray-900">Espace Citoyen</CardTitle>
                  <CardDescription className="text-lg">
                    Accédez à tous les services administratifs du Gabon
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-8 text-center">
                  <div className="space-y-6">
                    <div className="grid grid-cols-3 gap-4 text-center">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-purple-600">24h/7</div>
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-600">
                        <strong>DEMARCHE.GA</strong> vous permet d'accéder à tous les services administratifs gabonais depuis une seule interface.
                      </p>
                      
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        <p className="text-green-800 text-sm">
                          ✅ Interface unifiée • ✅ Tous les services • ✅ Démarches simplifiées
                        </p>
                      </div>
                    </div>
